<?PHP
class NSPE2method extends method{
	...
	public function getEa($where){
		...
		$sql .= " sec.* ";
		$sql .= " FROM ";
		$sql .= " nspe2_member as dm";
		$sql .= " INNER JOIN (SELECT * FROM nspe2_sec ) as sec ON sec.nspe2_id=dm.id";
		$sql .= " WHERE ";
