<?PHP
class NSPE1method extends method{
	...
	public function getEa($where){
		...
		$sql .= " sec.* ";
		$sql .= " FROM ";
		$sql .= " nspe1_member as dm";
		$sql .= " INNER JOIN (SELECT * FROM nspe1_sec ) as sec ON sec.nspe1_id=dm.id";
		$sql .= " WHERE ";
