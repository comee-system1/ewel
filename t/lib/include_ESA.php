<?PHP
class esamethod extends method{
	...
	public function ansClear($where){
	...
	public function getEa($where){
		...
		$sql .= " FROM ";
		$sql .= " esa_member as m";
		$sql .= " INNER JOIN (SELECT * FROM esa_sec ) as sec ON sec.esa_id=m.id";
		$sql .= " WHERE ";
