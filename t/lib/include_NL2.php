<?PHP
class NL2method extends method{
	...
	public function getEa($where){
		...
		$sql .= " sec.* ";
		$sql .= " FROM ";
		$sql .= " nl2_member as dm";
		$sql .= " INNER JOIN (SELECT * FROM nl2_sec ) as sec ON sec.mv_id=dm.id";
		$sql .= " WHERE ";
