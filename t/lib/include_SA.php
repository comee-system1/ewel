...
class SAmethod extends method{
	...
	public function getEa($where){
		...
		$sql .= " FROM ";
		$sql .= " mv_member as dm";
		$sql .= " INNER JOIN (SELECT * FROM mv_sec ) as sec ON sec.mv_id=dm.id";
		$sql .= " WHERE ";
