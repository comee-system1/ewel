<?PHP
class NSPE3method extends method{
	...
	public function getEa($where){
		...
		$sql .= " sec.* ";
		$sql .= " FROM ";
		$sql .= " nspe3_member as dm";
		$sql .= " INNER JOIN (SELECT * FROM nspe3_sec ) as sec ON sec.nspe3_id=dm.id";
		$sql .= " WHERE ";
