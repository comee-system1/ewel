...
class SPmethod extends method{
	...
	public function getEa($where){
		...
		$sql .= " FROM ";
		$sql .= " sp_member as dm";
		$sql .= " INNER JOIN (SELECT * FROM sp_sec ) as sec ON sec.sp_id=dm.id";
		$sql .= " WHERE ";
