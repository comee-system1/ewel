...
if (!$_REQUEST[ 'pageBack' ]) {
    if($_REQUEST[ 'type' ] == "subordinate"){
        ...
        if ($pager == 8) {
            ...
            if (strlen($result[ 'ans19' ]) == 0) $err[] = "設問19が未回答です。";
            if (strlen($result[ 'ans20' ]) == 0) $err[] = "設問20が未回答です。";
        ...
        if ($pager == 2) {
            ...
            $total = $result[ 'ans9' ]+$result[ 'ans10' ]+$result[ 'ans11' ]+$result[ 'ans12' ];
            if ($total != 100) {
                $err[] = "設問3に不備があります。";
            }

            if (strlen($result[ 'ans13' ]) == 0) {
                $err[] = "設問4が未回答です。";
            }
        ...
        if ($pager == 7) {
            if (strlen($result[ 'ans84' ]) == 0) $err[] = "設問14が未回答です。";
            if (strlen($result[ 'ans85' ]) == 0) $err[] = "設問15が未回答です。";
            if (strlen($result[ 'ans86' ]) == 0) $err[] = "設問16が未回答です。";
            if (strlen($result[ 'ans87' ]) == 0) $err[] = "設問17が未回答です。";
        }
        if ($pager == 6) {
            $q = 12;
            foreach ($line[$q] as $key=>$value) {
        ...
        if ($pager == 2) {
            ...
            if (strlen($result[ 'ans8' ]) == 0) {
                $err[] = "設問3(3)が未回答です。";
            }
            if (strlen($result[ 'ans9' ]) == 0) {
                $err[] = "設問3(4)が未回答です。";
            }
            $total = $result[ 'ans6' ]+$result[ 'ans7' ]+$result[ 'ans8' ]+$result[ 'ans9' ];
            if ($total != 100) {
                $err[] = "設問3に不備があります。";
            }
