...
$array_question[2] = "以下のような形で、チームのメンバーと仕事について話すことは、この1カ月の間で何回くらいありましたか（挨拶、業務連絡などの短時間の話、世間話を除く）。オンラインで話す場合も含めて、半角整数値で入力してください。
";
...
$q = 12;
$array_question[$q] = "ここからは、あなたが受講した『リーダーのフィードバックがメンバーの主体的行動に与える効果』の研修に関わることを伺います。以下の項目はどのくらいあてはまりますか。";
...
$i++;
$line[$q][$i][ 'key' ] = "65";
$line[$q][$i][ 'q' ] = "研修後,研修で示された「フィードバックの７つのチェックポイント」をよく覚えていた。";
...
$i++;
$line[$q][$i][ 'key' ] = "80";
$line[$q][$i][ 'q' ] = "メンバーに対するあなたのフィードバックの仕方";
$i++;
$line[$q][$i][ 'key' ] = "81";
...
$i=1;
$line[$q][$i][ 'key' ] = "84";
$array_question[$q] = "「チームのメンバーに対するフィードバック、および、チームメンバーとのコミュニケーション全般」について、研修後の変化として思いつくことを何でも書いてください。あなた自身のことでもメンバーのことでもどちらでもかまいません。【以後も含め、記述欄には400字以内で書いてください。】
";

$q = 15;
$i=1;
$line[$q][$i][ 'key' ] = "85";
$array_question[$q] = "「チームのメンバーに対するフィードバックの仕方」について、研修内容を実践することを促した要因、または、妨げた要因はどのようなものでしたか。思いつくことを何でも書いてください
";
...
$line[$q][$i][ 'key' ] = "87";
$array_question[$q] = "
このアンケートに対するご質問などがありましたらご記入ください。メールにて返答させていただきますのでアドレスを合わせてお知らせください。<br />
