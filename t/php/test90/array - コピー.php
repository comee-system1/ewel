...
$array_question[4] = "「メンバーの中であなたが業務上で最も頻繁に接する人」について、あなたの部下の中からお選びください。
<br />
<p class='text-danger'>
※接触頻度が同じ人が複数いる場合はその中で名字の最初の文字が50音順で最も早い人をお選びください。
</p>
";
$array_question[5] = "<span class='bossname'>".$bossname."</span>さんは何歳くらいですか。以下の選択肢からお答えください。
";
$array_question[6] = "<span class='bossname'>".$bossname."</span>さんは男性ですか、女性ですか。あてはまるものをお答えください";
...
$q = 13;
$array_question[$q] = "引き続き伺います。<br />あなたは【チームのメンバー（".$bossname."さんのもとで働いている人）と】以下の行動をどれくらいの頻度で行っていますか。";
$ans[$q][1] = "まったくしない";
$ans[$q][2] = "ほとんどしない";
$ans[$q][3] = "時々する";
$ans[$q][4] = "しばしばする";
...
$q = 14;
$array_question[$q] = "あなたは、チームのメンバー（".$bossname."さんのもとで働いている人）に対して、以下の行動をどれくらいの頻度で行っていますか。";
