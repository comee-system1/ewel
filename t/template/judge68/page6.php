...
<?php
    ...
    $num[81]['num'] = "①";
    $tle[81]['text'] = "";
    $ques[81]['text1'] = "あなたのフィードバックは、メンバーが仕事に費やしている努力を反映している";
    
    
    $line[82] = 82;
    $num[82]['num'] = "②";
    $tle[82]['text'] = "";
    $ques[82]['text1'] = "あなたのフィードバックは、メンバーが遂行した仕事に対して妥当なものだ";

    $line[83] = 83;
    $num[83]['num'] = "③";
    $tle[83]['text'] = "";
    $ques[83]['text1'] = "あなたがフィードバックする時は、メンバーに丁寧に接する";
    
    
    $line[84] = 84;
    $num[84]['num'] = "④";
    $tle[84]['text'] = "";
    $ques[84]['text1'] = "あなたがフィードバックする時は、メンバーに敬意を払う";
    
    $line[85] = 85;
    $num[85]['num'] = "⑤";
    $ques[85]['text1'] = "あなたがフィードバックする時は、メンバーと率直なコミュニケーションをする";
    
    
    $line[86] = 86;
    $num[86]['num'] = "⑥";
    $ques[86]['text1'] = "あなたがフィードバックをする時は、その理由を十分に説明する";
       
    $line[87] = 87;
    $num[87]['num'] = "⑦";
    $ques[87]['text1'] = "メンバーに対するフィードバックの<u><b>頻度</b></u>には、メンバーの間の差はない";
    
    $line[88] = 88;
    $num[88]['num'] = "⑧";
    $ques[88]['text1'] = "メンバーに対するフィードバックの<u><b>基準</b></u>には、メンバーの間の差はない";
    
    
    
    $line2[89] = 89;
    $num2[89]['num'] = "①";
    $ques2[89]['text1'] = "仕事上の失敗やミスが重大な結果をもたらすことが多い";

    $line2[90] = 90;
    $num2[90]['num'] = "②";
    $ques2[90]['text1'] = "自律的に決定を行って仕事を進める";
    
    $line2[91] = 91;
    $num2[91]['num'] = "③";
    $ques2[91]['text1'] = "社内で競争することが求められる";
    
    $line2[92] = 92;
    $num2[92]['num'] = "④";
    $ques2[92]['text1'] = "非常にたくさんの仕事をしなければならない";
    
    $line2[93] = 93;
    $num2[93]['num'] = "⑤";
    $ques2[93]['text1'] = "高度の知識や技術が必要なむずかしい仕事だ";
    
    $line2[94] = 94;
    $num2[94]['num'] = "⑥";
    $ques2[94]['text1'] = "メンバー全員がお互いに同程度のコミュニケーションをしている";
    
    $line2[95] = 95;
    $num2[95]['num'] = "⑦";
    $ques2[95]['text1'] = "チームで行うコミュニケーションがあなたに集中している";
    
    $line2[96] = 96;
    $num2[96]['num'] = "⑧";
    $ques2[96]['text1'] = "チーム以外の人とのコミュニケーションが多い";
    
    $line2[97] = 97;
    $num2[97]['num'] = "⑨";
    $ques2[97]['text1'] = "チームの中での上下関係が強い";
    
    $line2[98] = 98;
    $num2[98]['num'] = "⑩";
    $ques2[98]['text1'] = "このチームでミスを犯したら、たいていの場合、責められる";
    
    $line2[99] = 99;
    $num2[99]['num'] = "⑪";
    $ques2[99]['text1'] = "このチームのメンバーは、問題のあることがらや困難な事案について発言できる";
    
    $line2[100] = 100;
    $num2[100]['num'] = "⑫";
    $ques2[100]['text1'] = "このチームでは、メンバーが「自分とは違う」ことを理由に他者を拒否することがある";
    
    $line2[101] = 101;
    $num2[101]['num'] = "⑬";
    $ques2[101]['text1'] = "このチームでは、リスクを取ることについて心配することはない";
    
    $line2[102] = 102;
    $num2[102]['num'] = "⑭";
    $ques2[102]['text1'] = "このチームでは他のメンバーに助けを求めることは難しい";
    
    $line2[103] = 103;
    $num2[103]['num'] = "⑮";
    $ques2[103]['text1'] = "このチームには、故意に私の努力を妨害するような人はいない";
    
    $line2[104] = 104;
    $num2[104]['num'] = "⑯";
    $ques2[104]['text1'] = "このチームのメンバーと一緒に働いていると、私特有のスキルや能力が高く評価され活かされる";
