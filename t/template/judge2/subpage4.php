...
<?php
    ...
    $line[$k] = $k;
    $num[$k]['num'] = "①";
    $ques[$k]['text1'] = "仕事上の失敗やミスが重大な結果をもたらすことが多い";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "②";
    $ques[$k]['text1'] = "自律的に決定を行って仕事を進める";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "③";
    $ques[$k]['text1'] = "社内で競争することが求められる";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "④";
    $ques[$k]['text1'] = "非常にたくさんの仕事をしなければならない";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑤";
    $ques[$k]['text1'] = "高度の知識や技術が必要なむずかしい仕事だ";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑥";
    $ques[$k]['text1'] = "各メンバーがメンバー全員とコミュニケーションしている";
...
*/
    ...
    $line[$k] = $k;
    $num[$k]['num'] = "⑮";
    $ques[$k]['text1'] = "このチームでは、私特有のスキルや能力は評価され活かされることはほとんどない";
