...
<?php
    ...
    $ques[23]['text2'] = "チームメンバー全体と話をすること";



    $line2[24] = 24;
    $num2[24]['num'] = "①";
    $tle2[24]['text'] = "効果的に働けているかについて";
    $ques2[24]['text1'] = "<u>あなたが</u>仕事で何か良い働きをしたときは、<u>あなたに</u>それを伝える";
    $ques2[25]['text2'] = "<u>チーム全体が</u>仕事で何か良い働きをしたときは、<u>チーム全体に</u>それを伝える";

    $line2[26] = 26;
    $num2[26]['num'] = "②";
    $tle2[26]['text'] = "仕事の進め方について";
    ...
    $line2[30] = 30;
    $num2[30]['num'] = "④";
    $ques2[30]['text1'] = "<u>あなたが</u>仕事で何か間違いを犯したときは、<u>あなたに</u>それを伝える";
    $ques2[31]['text2'] = "<u>チーム全体が</u>仕事で何か間違いを犯したときは、<u>チーム全体に</u>それを伝える";
    ...
    $ques3[36]['text1'] = "効果的に働けているかについて、<u>あなたは</u>定期的に考える";
    $ques3[37]['text2'] = "効果的に働けているかについて、<u>チーム全体で</u>定期的に考える";

    $line3[38] = 38;
    $num3[38]['num'] = "②";
    $tle3[38]['text'] = "仕事の進め方について";
    $ques3[38]['text1'] = "仕事の進め方について、<u>あなたは</u>たびたび考える";
    $ques3[39]['text2'] = "仕事の進め方について、<u>チーム全体で</u>たびたび考える";
    ...
    $line4[44] = 44;
    $num4[44]['num'] = "⑤";
    $ques4[44]['text1'] = "<u>あなたは自分の</u>職務の目標を達成している";
    $ques4[45]['text2'] = "<u>チーム全体は自分達の</u>職務の目標を達成している";
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="<?=$g?>">
                            ...
                            <?php else: $c = 2;?>
							<?php endif; ?>
                            <td rowspan=""  colspan="<?=$c?>"><?=$ques2[$top][ 'text1' ]?></td>
                        ...
                        <tr class="<?=$g?>" >
                            <td rowspan=""   colspan="<?=$c?>" ><?=$ques2[$top+1][ 'text2' ]?></td>
                            <?php foreach($ans2 as $key2=>$val2):?>
                            <?php
                                $chked  ="";
                                $t = $top+1;
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="<?=$g?>">
                            ...
                            <td rowspan=""  colspan="2" ><?=$ques3[$top][ 'text1' ]?></td>
                            <?php foreach($ans2 as $key2=>$val2):?>
                            <?php
                                $chked  ="";
                                $a = "ans".$top;
                        ...
                        <tr class="<?=$g?>" >
                            <td rowspan=""  colspan="2" ><?=$ques3[$top+1][ 'text2' ]?></td>
                            <?php foreach($ans2 as $key2=>$val2):?>
                            <?php
                                $chked  ="";
                                $t = $top+1;
