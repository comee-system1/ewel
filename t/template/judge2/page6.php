...
*/
    ...
    $line2[$numb] = $numb;
    $num2[$numb]['num'] = "⑥";
    $ques2[$numb]['text1'] = "このチームのメンバーは、問題のあることがらや困難な事案でも言い出すことができる";
    ...
    $line2[$numb] = $numb;
    $num2[$numb]['num'] = "⑩";
    $ques2[$numb]['text1'] = "このチームでは、私特有のスキルや能力が評価され活かされることはほとんどない";
	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST">
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    <tr>
                        <th rowspan="2">１３</th>
                        <th  rowspan="2">チームメンバーに対するあなたの<u>ネガティブな</u>フィードバック（悪いところの指摘）について、
                        以下の項目は、どのくらいあてはまりますか。最もよくあてはまるものをひとつずつ選んでください。
                            </th>
