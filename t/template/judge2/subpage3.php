...
<?php
    ...
    $line[$k] = $k;
    $num[$k]['num'] = "①";
    $ques[$k]['text1'] = "<u>".$bossname."</u>がフィードバックをする時は、チームの目標を明確に伝えている";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "②";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のフィードバックは、目標に向けてチームを方向づけている";


    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "③";
    $ques[$k]['text1'] = "<u>".$bossname."</u>がフィードバックをする時は、各メンバーの役割を明確に伝えている";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "④";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のフィードバックは、各メンバーが自分の役割を果たすよう促している";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑤";
    $ques[$k]['text1'] = "<u>".$bossname."</u>がフィードバックをする時は、メンバーの協力体制を明確にしている";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑥";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のフィードバックは、メンバーが互いに協力するように促している";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑦";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のフィードバックに対して、メンバーは自分の考えや気持ちを言える";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑧";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のフィードバックの仕方は、相手や状況が違っても一貫している";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑨";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のフィードバックの仕方は、倫理的および道徳的な基準を守っている";
    ...
    $line[$k] = $k;
    $num[$k]['num'] = "⑯";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のあなたに対するフィードバックの頻度は、他のメンバーに対してよりも高い";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑰";
    $ques[$k]['text1'] = "<u>".$bossname."</u>のあなたに対するフィードバックの基準は、他のメンバーに対してよりも厳しい";

    $k = $k+1;
    $line[$k] = $k;
    $num[$k]['num'] = "⑱";
    $ques[$k]['text1'] = "<u>".$bossname."</u>は、自分自身の利益のためではなく、チームの利益のためにフィードバックをしている";
    ...
    $line3[$k] = $k;
    $num[$k]['num'] = "⑬";
    $ques[$k]['text1'] = $bossname."以外のチームメンバーの中で、リーダーのような役割を担っている";

    $k = $k+1;
    $line3[$k] = $k;
    $num[$k]['num'] = "⑭";
    $ques[$k]['text1'] = $bossname."以外のチームメンバーの中で、パフォーマンスが高いほうだ";
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th colspan="" rowspan="2">
                            	チームメンバーに対する<?=$bossname?>の<u>ネガティブな</u>フィードバック（悪いところの指摘）について、以下の項目は、どのくらいあてはまりますか。最もよくあてはまるものをひとつずつ選んでください。
                            </th>
