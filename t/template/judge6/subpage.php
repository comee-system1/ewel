	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST" name="form1">
        ...
        <table class="table table-bordered" style="width:600px;">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">4</th>
                    <td><?=$bossname?>さんがチームのメンバーにフィードバックをすること（メンバー個人に対してとメンバー全員に対してをすべて足した回数をお答えください。あなたが見聞きしたものの概数で結構です。）</td>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered">
                <tr class="bg-primary" style="color:white;vertical-align:middle;">
                    <th></th>
        ...
        <div class="col-md-12">
            ...
            <div class="text-end" style="width:100px;float:right;">
