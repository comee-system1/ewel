	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST" name="form1">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <textarea id="countUp1" class="form-control" rows=6 name="ans[<?=$line[$q][1][ 'key' ]?>]" ><?=$result[$a]?></textarea>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- 20220908 山本カウントアップ追加 -->
                <textarea id="countUp2" class="form-control" rows=6 name="ans[<?=$line[$q][1][ 'key' ]?>]" ><?=$result[$a]?></textarea>
...
// 文字数カウント　山本
$(function() {
    $('#countUp1').keyup(function() {
        var count = $(this).val().length;
        $('#count1').text(count);
    });
});
$(function() {
    $('#countUp2').keyup(function() {
        var count = $(this).val().length;
        $('#count2').text(count);
    });
});
