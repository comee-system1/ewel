...
?>
			...
			<ol class="question " >
        		<?php if($question[$pager][2][1]): ?><li class="kt">ア.</li><li class="bl f18 mb10"><?=$question[$pager][2][1]?></li><?php endif; ?>
				<?php if($question[$pager][2][2]): ?><li class="kt">イ.</li><li class="bl f18 mb10"><?=$question[$pager][2][2]?></li><?php endif; ?>
				<?php if($question[$pager][2][3]): ?><li class="kt">ウ.</li><li class="bl f18 mb10"><?=$question[$pager][2][3]?></li><?php endif; ?>
				<?php if($question[$pager][2][4]): ?><li class="kt">エ.</li><li class="bl f18 mb10"><?=$question[$pager][2][4]?></li><?php endif; ?>
				<?php if($question[$pager][2][5]): ?><li class="kt">オ.</li><li class="bl f18 mb10"><?=$question[$pager][2][5]?></li><?php endif; ?>
				<?php if($question[$pager][2][6]): ?><li class="kt">カ.</li><li class="bl f18 mb10"><?=$question[$pager][2][6]?></li><?php endif; ?>
			</ol>
<?PHP
		}
?>
...
?>
				...
				<div class="right <?=$imgmt[$pager]?>">
					<img src="<?=D_URL?>images/elans/elan<?=$pager?>.jpg">
				</div>
			</div>
