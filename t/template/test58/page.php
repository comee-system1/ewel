...
?>
                                    <li class="bl jisage" ><div class="l40 <?=$css[$pager][3][2]?>"><input type="radio" name="ans<?=$pager?>" class="ans1 radio" id="ans1-2" value="2" ></div><div class="l40 <?=$ml[$pager][2]?> <?=$css[$pager][3][2]?> ml60"><label for="ans1-2" ><span class="f18"><?=$question[$pager][3][2]?></span></label></div></li>
<?PHP
				}
...
?>
				...
				<div class="right <?=$imgmt[$pager]?>">
					<img src="<?=D_URL?>images/elan3/elan<?=$pager?>.jpg">
				</div>
			</div>
