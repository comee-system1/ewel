...
<?PHP } ?>
    ...
    <div class="row">
            ...
            <div class="col-md-12 mt-5">
                ...
                <textarea name="ans[<?=$line[$q][1][ 'key' ]?>]" class="form-control " id="count1" rows=5 maxlength=500 ><?=$result[$a]?></textarea>
                <div class="text-end">(<span id="total1">0</span>/500)</div>
            </div>
            <div class="col-md-12 mt-5">
                <?php 
                $q = 20;
                ...
                <textarea name="ans[<?=$line[$q][1][ 'key' ]?>]" class="form-control" id="count2" rows=5 maxlength=500><?=$result[$a]?></textarea>
                <div class="text-end">(<span id="total2">0</span>/500)</div>
            </div>
            <div class="col-md-12 mt-5">
                <?php 
                $q = 21;
                ...
                <textarea name="ans[<?=$line[$q][1][ 'key' ]?>]" class="form-control" id="count3" rows=5 maxlength=500><?=$result[$a]?></textarea>
                <div class="text-end">(<span id="total3">0</span>/500)</div>
            </div>
...
$.fn.count1 = function(){
    let value = $("#count1").val().length;
    $("#total1").text(value);
};
$.fn.count2 = function(){
    let value = $("#count2").val().length;
    $("#total2").text(value);
};
$.fn.count3 = function(){
    let value = $("#count3").val().length;
    $("#total3").text(value);
};
