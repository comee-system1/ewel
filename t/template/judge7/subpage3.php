...
?>
<div style="text-align:right;">3/<?=$max?>ページ</div>
<?PHP if(count($err)){ ?>
	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST" name="form1">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php $q = 14;?>
                <dl>
                    <dt  style="float:left;width:30px;font-weight:normal;">10.</dt>
                    <dd  style="float:left;width:90%"><?=$array_question[$q]?></dd>
                </dl>
                <table class="table table-bordered">
                    <tr class="bg-primary text-white text-center align-middle">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php $q = 15;?>
                <dl>
                    <dt  style="float:left;width:30px;font-weight:normal;">11.</dt>
                    <dd  style="float:left;width:90%"><?=$array_question[$q]?></dd>
                </dl>
                <table class="table table-bordered">
                    <tr class="bg-primary text-white text-center align-middle">
