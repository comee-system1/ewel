...
?>
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&anq=<?=$_REQUEST[ 'anq' ]?>" method="POST">
		...
		<ol>
			<li>研修後の状況について、フォローアップアンケートを実施します。研修内容についての意識づけの意味もありますのでぜひご協力ください。所要時間は3分程度です。</li> 
			<li>回答を入力しないと次ページに進めません。</li> 
			<li>この意識調査の個人の回答は会社や部下には開示されません。</li>
	...
	<div class="center" style="text-align:center;">
		<input type="button" value="閉じる" class="button" onClick="window.close(); return false;">
