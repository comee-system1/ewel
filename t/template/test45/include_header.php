...
if($css1){
?>
<LINK rel="stylesheet" href="<?=D_URL?>css/test/type45/<?=$css1?>.css" type="text/css">
<?PHP
}
?>
<?PHP
if($css2){
?>
<LINK rel="stylesheet" href="<?=D_URL?>css/test/type45/<?=$css2?>.css" type="text/css">
<?PHP
}
?>
<?PHP
...
?>
<script src="<?=D_URL?>js/test/type45/<?=$val?>.js" type="text/javascript"></script>
<?PHP
	}
}
?>
