	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>" method="POST">
		...
		<table id="table">
			...
			<tr>
				...
				<div class="thumb"><img src="<?=D_URL?>images/vf2/No4.gif"  ></div>
				</td>

				<td>
				<p>自分の考えをきちんと相手に伝えることができず、不適切な意見でも同調しやすく、反論できない。</p>
				<div class="thumb"><img src="<?=D_URL?>images/vf2/No5.gif"  ></div>
				</td>
		...
		<ul id="ansLine">
			<li class="radio" id="li_1"><div class="indent" ><input type="radio" name="sample" value="1" id="chk_1"></div>
				<img src="/image/check_off.gif" class="radio img" id="img_1" />明確にＡ</li>
			<li class="radio" id="li_2"><div class="indent" ><input type="radio" name="sample" value="2" id="chk_2"></div>
				<img src="/image/check_off.gif" class="radio img" id="img_2" />どちらかというとＡ</li>
			<li class="radio" id="li_3"><div class="indent" ><input type="radio" name="sample" value="3" id="chk_3"></div>
				<img src="/image/check_off.gif" class="radio img" id="img_3" />どちらかというとＢ</li>
			<li class="radio" id="li_4"><div class="indent" ><input type="radio" name="sample" value="4" id="chk_4"></div>
				<img src="/image/check_off.gif" class="radio img" id="img_4" />明確にＢ</li>
