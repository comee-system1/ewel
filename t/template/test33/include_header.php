...
if($css1){
?>
<LINK rel="stylesheet" href="<?=D_URL?>css/test/type33/<?=$css1?>.css" type="text/css">
<?PHP
}
?>
<script src="<?=D_URL?>js/test/type33/jquery.hoverpulse.js" type="text/javascript"></script>

<?PHP
if(count($js)){
	foreach($js as $key=>$val){
?>
<script src="<?=D_URL?>js/test/type33/<?=$val?>.js" type="text/javascript"></script>
<?PHP
	}
}
?>
