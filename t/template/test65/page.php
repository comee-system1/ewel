...
?>
			...
			<ul class="question" >
        <?php if($question[$pager][2][1]): ?><li class="bl f18 mb10"><?=$question[$pager][2][1]?></li><?php endif; ?>
				<?php if($question[$pager][2][2]): ?><li class="bl f18 mb10"><?=$question[$pager][2][2]?></li><?php endif; ?>
				<?php if($question[$pager][2][3]): ?><li class="bl f18 mb10"><?=$question[$pager][2][3]?></li><?php endif; ?>
				<?php if($question[$pager][2][4]): ?><li class="bl f18 mb10"><?=$question[$pager][2][4]?></li><?php endif; ?>
				<?php if($question[$pager][2][5]): ?><li class="bl f18 mb10"><?=$question[$pager][2][5]?></li><?php endif; ?>
			</ul>
<?PHP
		}
?>
...
?>
				...
				<div class="right <?=$imgmt[$pager]?>">
					<img src="<?=D_URL?>images/elan5/elan<?=$pager?>.jpg">
				</div>
			</div>
