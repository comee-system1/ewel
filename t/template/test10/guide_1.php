...
?>
	<form action="/tamen/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>" method="POST">
		<ol>
			<li class="red">各質問に対し、評価対象者が取るであろう行動、傾向を選択肢の中から選択してください。</li>
			<li>回答を入力しないと次ページに進めません。</li>
			<li>ブラウザの戻るボタンは使えません。ページ下部の「戻る」で、前のページに戻れます。 </li>
			<li>受検時間の目安は10分です。各ページの右上に残り時間が表示されます。本検査は１０分を超えても自動的に採点される 事はありません。</li>
			<li><b>長時間(<?=$times[ 'minute_rest' ]?>分)アクセスのないまま放置されますと、システム側より強制ログアウトされますので、 ご注意ください。
					その場合、再度ログインし直し、検査の最初から再度ご受検いただくことになります。</b></li>
