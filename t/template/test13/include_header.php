...
if($flgs != "guide"){
	switch($language){
		case "4";
			...
			$text[1] = "Trang";
			$text[2] = "Tình hình trả lời câu hỏi (Trang có câu hỏi chưa trả lời được thể hiện bằng màu đỏ)";
			$text[3] = "";
			$text[4] = "";
			$text[5] = "";
			$text[6] = "";
...
if($css1){
?>
<LINK rel="stylesheet" href="<?=D_URL?>css/test/type13/<?=$css1?>.css" type="text/css">
<?PHP
}
?>
...
?>
<script src="<?=D_URL?>js/test/type13/<?=$val?>.js" type="text/javascript"></script>
<?PHP
	}
}
?>
