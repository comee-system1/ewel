...
?>
	...
	<div class="f18">
		<table class="table6">
			<tr>
				<td>Số hộ khảo sát</td>
				<td>・・・・・</td>
				<td>1.000  hộ</td>
			</tr>
			<tr>
				<td>Số hộ mua báo A</td>
				<td>・・・・・</td>
				<td>460  hộ</td>
			</tr>
			<tr>
				<td>Số hộ mua báo B</td>
				<td>・・・・・</td>
				<td>250  hộ</td>
			</tr>
			<tr>
				<td>Số hộ mua cùng lúc báo A và báo B</td>
				<td>・・・・・</td>
				<td>100  hộ</td>
			</tr>
		</table>
		<p>Lúc này, số hộ không mua báo A lẫn báo B là bao nhiêu hộ?</p>
		<table class="table">
<?PHP
			$ans = "ans".$exam[ 'no' ];
			$chks = $tdetail[$ans];
