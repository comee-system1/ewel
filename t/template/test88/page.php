...
?>
		...
		<div class="box">
			...
			<div class="left">
				...
				<?PHP endif;?>
				<?php if($question[$pager][3][6]): ?>
					<ul class="questionlist">
						<li><input type="radio" name="ans<?=$pager?>" class="ans2 radio" id="ans1-6" value="6"></li>
						<li><?=$array_number[6]?></li>
						<li><label for="ans1-6"><?=$question[$pager][3][6]?></label></li>
					</ul>
				<?PHP endif;?>
