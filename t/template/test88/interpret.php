...
?>
		...
		<div class="box">
			...
			<ul class="question">
				...
				<li class="bl"><?=$array_number[1]?><?=$question[$pager][3][1]?></li>
				<?php endif; ?>
				<?php if($question[$pager][3][2]): ?>
				<li class="bl"><?=$array_number[2]?><?=$question[$pager][3][2]?></li>
				<?php endif; ?>
				<?php if($question[$pager][3][3]): ?>
				<li class="bl"><?=$array_number[3]?><?=$question[$pager][3][3]?></li>
				<?php endif; ?>
				<?php if($question[$pager][3][4]): ?>
				<li class="bl"><?=$array_number[4]?><?=$question[$pager][3][4]?></li>
				<?php endif; ?>
				<?php if($question[$pager][3][5]): ?>
				<li class="bl"><?=$array_number[5]?><?=$question[$pager][3][5]?></li>
				<?php endif; ?>
			</ul>
