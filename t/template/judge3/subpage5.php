...
<?php
    ...
    $line2[$k] = $k;
    $num[$k]['num'] = "①";
    $ques[$k]['text1'] = "このチーム全体の会議・ミーティングの頻度は十分に高い";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "②";
    $ques[$k]['text1'] = "このチーム全体の会議・ミーティングの質は十分に高い";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "③";
    $ques[$k]['text1'] = "このチーム全体として、情報共有が十分にできている";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "④";
    $ques[$k]['text1'] = "このチームのメンバー間で、仕事量の差が大きい";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑤";
    $ques[$k]['text1'] = "このチームのメンバー間で、能力の差が大きい";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑥";
    $ques[$k]['text1'] = "このチームのメンバー間で、モチベーションの強さの差が大きい";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑦";
    $ques[$k]['text1'] = "このチームのメンバー間で、世代や採用タイプ（新卒・中途）による差が大きい";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑧";
    $ques[$k]['text1'] = "このチームのメンバー間で、明確な対立関係がある";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑨";
    $ques[$k]['text1'] = "このチームでは、責任の所在が明確である";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑩";
    $ques[$k]['text1'] = "このチームでは、責任が特定の人に集中している";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑪";
    $ques[$k]['text1'] = "このチーム全体としての目標が明確である";
    
    $k = $k+1;
    $line2[$k] = $k;
    $num[$k]['num'] = "⑫";
    $ques[$k]['text1'] = "このチーム全体としての問題点が明確である";
