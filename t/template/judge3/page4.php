	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST">
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    <tr>
                        <th rowspan="2">８</th>
                        <th colspan="2" rowspan="2">あなたは以下のことをそれぞれの人・チーム全体に対してどれくらいの頻度でしていますか。</th>
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    <tr>
                        <th rowspan="2">９</th>
                        <th colspan="" rowspan="2">あなたの普段の行動について、以下の項目は、どのくらいあてはまりますか。最もよくあてはまるものをひとつずつ選んでください。</th>
