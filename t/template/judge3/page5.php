...
<?php
    ...
    $num[49]['num'] = "①";
    $tle[49]['text'] = "";
    $ques[49]['text1'] = "<u>".$subA."</u>は自分の職務の目標を達成している";
    $ques[50]['text2'] = "<u>".$subB."</u>は自分の職務の目標を達成している";
    $ques[51]['text3'] = "<u>チーム全体は</u>自分達の職務の目標を達成している";
    ...
    $num[55]['num'] = "③";
    $tle[55]['text'] = "";
    $ques[55]['text1'] = "<u>".$subA."</u>は自分の職務として要求されていることをすべて達成している";
    $ques[56]['text2'] = "<u>".$subB."</u>は自分の職務として要求されていることをすべて達成している";
    $ques[57]['text3'] = "<u>チーム全体は</u>自分達の職務として要求されていることをすべて達成している";
	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST">
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    <tr>
                        <th rowspan="2">１０</th>
                        <th  rowspan="2">それぞれの仕事について、以下の項目は、どのくらいあてはまりますか。最もよくあてはまるものをひとつずつ選んでください。</th>
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    <tr>
                        <th rowspan="2">１１</th>
                        <th colspan="" rowspan="2">部下それぞれに対するあなたのお考えについて、以下の項目は、どのくらいあてはまりますか。最もよくあてはまるものをひとつずつ選んでください。</th>
