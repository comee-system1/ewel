...
?>
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>" method="POST">
		...
		<p class="f18">
			...
			<span class="red">なお本検査は、設問の信頼性を検証するテスト段階のため、通常より設問数が多く なっています。<br />
			同様の設問が、違う形で複数回問われる場合がありますので、ご了承ください。</span>
		</p>


		<ol>
			<li>各質問に対し、現在のご自身に当てはまる行動を、選択肢の中から選択してください。 </li> 
			<li>回答を入力しないと次ページに進めません。 </li>
			<li>ブラウザの「戻る」ボタンは使えません。ページ下部の「1つ前のページに戻る」で、1ページ前にだけ戻れます。 </li>
			<li>設問は121問で、受検時間の目安は20分です。 </li>
