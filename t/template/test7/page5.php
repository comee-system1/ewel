...
?>
	...
	<div class="questionBox">
		...
		<img src="<?=D_URL?>/images/rs/<?=$exam[ 'img' ]?>" />
	</div>
	<div class="exBox"><?=$exam[ 'code_sub' ]?></div>
	<div class="answerBox">
	<br cler=all />
	<table class="ansTbl5">
...
?>
			...
			<tr>
				<td class="tle" rowspan=3 ><img src="<?=D_URL?>/images/rs/<?=$val?>" ></td>
...
?>
					<td id="td_<?=$key?>_<?=$i?>" class="td_<?=$key?> <?=$c?> heights" >
