...
//	echo ",関係者ID";
	...
	//上司用
	echo ",あなたのチームのリーダ○○さんについて伺います。○○さんは、何歳くらいですか。半角整数値でお答えください。";
	echo ",○○さん は、男性ですか、女性ですか。";
	echo ",現在のチームで働き始めてからどれくらい経ちますか。「〇年〇か月」という形式で半角整数値でお答えください。";
	echo ",あなたのチームのメンバーは、何人いますか。○○さんを除いた数を半角整数値でお答えください。";
