<?PHP
	...
	//行動価値検査2
	//---------------------------------------------------
	include_once("./init/rowData/dev_data_ta3.php");
	include_once("./init/rowData/raw_data_ta3.php");
	include_once("./lib/keisan/functionBA12.php");
	...
	while( $line = $db->fgetcsv_reg($fp, 1000)){
		if($no >= 4){
			...
			list($row,$lv,$standard_score,$dev_number) = BA12($line,$row2,$raw_data,$dev_data,true);
