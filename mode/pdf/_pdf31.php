...
$myPicture = new pImage(530,520,$MyData); 
...
// フォンとサイズ、色のを切り替え 
$myPicture->setFontProperties(array("FontName"=>"./init/Fonts/TakaoPMincho.ttf","FontSize"=>16,"R"=>80,"G"=>80,"B"=>80)); 
...
$myPicture->setGraphArea(150,-100,530,520); 
// レーダーチャートのオプション 
$Options = array( 
