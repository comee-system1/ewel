<?PHP
	...
	$array_pdf_question = array(
				...
				"dev2"=>array(
						...
						,"他人の指摘を素直に受け入れている事例が\nあり、その後具体的な行動としての例を説明することができれば問題ありません。ただし、失敗を受け入れていない、もしくは、指摘内容を直そうとしていない場合や、失\n敗を指摘されたことがない場合には、「リスクとなる行動」が起こる可能性を否定できません。"
						),
				"dev3"=>array(
						"自分の能力・知識・経験に\n自信をもてないため、何事\nにも不安に感じ、自分を卑下するような行動を取る可能性があります。\n\n\n\n"
						,"「あなたが一番自信をもてることは何ですか？」 「それを実践した具体的な例を聞かせてください。それは、いつ、どのような場面の、どんな行動として発揮しましたか。」\n\n\n\n"
						,"自分の中で自信をもっていることがあり、\nしかもそれが行動として発揮されている例があれば問題ありません。ただし、まったく自信をもっていることがない、あるいは、自信を持っていてもそれが実践されてい\nる行動が無かった場合には、「リスクとなる行動」が起こる可能性を否定できません。"
						),
				"dev4"=>array(
				...
				"dev7"=>array(
						...
						,"ある場合、他者と衝突していても、相手の\n立場を尊重するような形で解決している事例があれば問題ありません。ない場合でも、他者に配慮した行動であれば問題ありません。ただし、衝突を解決した事例も、他\n者に配慮した事例も無い場合は、「リスク\nとなる行動」が起こる可能性を否定できません。"
						),
				"dev8"=>array(
				...
				"dev9"=>array(
						...
						,"他者が困っていることに対し、自分から積\n極的に関わっていく例があれば問題ありません。ただし、他者が困っている際に助けた経験がない、あるいは、周囲が困っていることを気づくことができない場合には、「リスクとなる行動」が起こる可能性を否定できません。\n\n"
						),
				"dev10"=>array(
						"自分の考えをもたず、他者\nの意見に流されやすく、集団を率いるような行動が期待できない可能性があります。\n\n\n\n"
						,"「あなたは他者に対し、自分の意見を伝\nえたり、アドバイスを与えた経験はありますか？」「その相手からの反応やその後の行動に変化はありましたか？」\n\n\n\n\n"
						,"他者に対してアドバイスをしたり、自分の\n意見を伝えることで周囲に積極的に働きかけている事例が出てくれば問題ありません。ただし、相手に対して、自分の意見を伝\nえたり、アドバイスした事例も無い場合は、「リスクとなる行動」が起こる可能性を否定できません。\n\n"
						),
				"dev11"=>array(
						"自分の考えをきちんと相手\nに伝えることができず、不適切な意見に対して同調しやすく、反論できない可能性があります。\n\n\n\n"
						,"「自分と他者の考え方がずれて衝突や対\n立をしたような経験はありますか？」ある場合：「その衝突や対立をどうやって解決しましたか？」ない場合：「他者を\n気遣い、うまく相手に合わせてあげた経\n験があれば、その内容を具体的にお話ください。」\n\n"
						,"「ある場合」に、他者と衝突・対立しても、相手の立場を尊重する形で解決している\n事例が出てくれば問題ありません。「ない場合」も、他者に配慮した行動をとっていることが確認できれば問題ありません。ただし、衝突を解決したり、他者に配慮した\n事例が無い場合は、「リスクとなる行動」が起こる可能性を否定できません。"
						),
				"dev12"=>array(
						"自ら周囲に働きかけること\nはなく、また、周囲と気軽に会話ができず、孤立する可能性があります\n\n\n\n\n"
						,"「人とのコミュニケーションで失敗してしまったことがありますか？」「具体的な例を聞かせてください。それは、いつ、どのような場面でどのように失敗しましたか。結果はどうなりましたか。」\n\n\n\n"
						,"自分から積極的に相手に関わっていこうと\nする姿勢が伺える事例が出てくれば問題あ\nりません。また、人の話を聞こうとする姿勢が確認できれば問題ありません。ただし、相手に対し、拒否や防御的な態度が原因で失敗している場合は、「リスクとなる行動」が起こる可能性を否定できません。\n\n"
						),
				"space"=>array("　　　　　　　　　　　　　　　　　　　　　　　　"
						,"　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　"
						),
