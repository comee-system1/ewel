...
*/
	...
	*/
	...
	$pdf->MultiCell(45, 40,$a_questions[$keys[0]] ,"0","C",false,0,10,234,true,0,true,'M');
	$pdf->MultiCell(38, 40,$array_pdf_question[$keys[0]][0],"0","L",false,0,55,223,true,0,true,'M');
	$pdf->MultiCell(52, 40,$array_pdf_question[$keys[0]][1],"0","L",false,0,91,223,true,0,true,'M');
	$pdf->MultiCell(56, 40,$array_pdf_question[$keys[0]][2],"0","L",false,0,145,223,true,0,true,'M');

	$pdf->MultiCell(45, 0,$a_questions[$keys[1]] ,"0","C",false,0,10,268,true,0,true,'M');
	$pdf->MultiCell(38, 0,$array_pdf_question[$keys[1]][0],"0","L",false,0,55,254.5,true,0,true,'M');
	$pdf->MultiCell(52, 0,$array_pdf_question[$keys[1]][1],"0","L",false,0,91,254.5,true,0,true,'M');
	$pdf->MultiCell(56, 0,$array_pdf_question[$keys[1]][2],"0","L",false,0,145,254.5,true,0,true,'M');
