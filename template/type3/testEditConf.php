...
?>
		<tr>
			<th>メールアドレス</th>
			<td><?=$mail?><input type="hidden" name="mail" value="<?=$mail?>" ></td>
		</tr>
		<tr>
			<th>添削者名</th>
			<td><?=$tensaku_name?><input type="hidden" name="tensaku_name" value="<?=$tensaku_name?>" ></td>
		</tr>
		<tr>
			<th>添削者メールアドレス</th>
			<td><?=$tensaku_mail?><input type="hidden" name="tensaku_mail" value="<?=$tensaku_mail?>" ></td>
		</tr>
<?PHP
		}
?>
	...
	<div id="buttonBox">
			<input type="submit" name="back"  value="<?=$tstr17?>" class="button" >
			<input type="submit" name="regist" value="<?=$tstr18?>" class="button" >
	</div>
	</form>
	</div>
	<br clear=all />
