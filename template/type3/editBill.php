...
<div id="main">
	<div id="contents">
		...
		<div class="leftbox">
			...
			<input type="text" name="cus_busyo" value="<?=$main[0][ 'rep_busyo' ]?>" id="busyo" placeholder="部署を入力してください"><br />
...
?>
			...
			〒<input type="text" name="post1" value="<?=$company['1']?>"  maxlength=3 id="company_post1" >-
				...
				<input type="text" name="address" value="<?=$company[ '3' ]?><?=$company[ '4' ]?>" id="company_address" ><br />
